...
abstract public class Compteur implements ActionListener{
	...
	//la méthode qui compte le temps
	...
	}//la fin de la méthode compteur	

	//pour arréter le compteur
	...
	//get le temps écoulé en minutes
	public static int getTempEcouleMinutes(){
		return tempsEcouleMinutes;
	}

	//la fonction vérifier qui vérifier le temps
